        ...
        <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          <div className="mt-12 text-center">
            <a
              href="/auth/sign-in"
              className="inline-block rounded bg-teal-500 px-12 py-3 text-sm font-medium text-white transition hover:bg-pink-700 focus:outline-none focus:ring focus:ring-yellow-400"
            >
              Get Started Today
            </a>
          </div>
